      ...
      <div className='bg-white rounded-lg xl:h-[80vh] w-[60%] flex gap-6 flex-wrap justify-around items-center p-14 pt-6'>
        ...
        <div className='flex flex-col gap-3 pb-10'>
          ...
          <select
            ...
            className='outline-none border-2 border-gray-200 text-md capitalize lg:p-4 lg:py-2 p-2 rounded cursor-pointer'
          >
            {
              topics.map(topic => (
                <option
